...
const GithubStats = ({ username }: Props) => {
  ...
  if (error) {
    return (
      <Card className="p-4 sm:p-6 bg-card border-borrder/5">
  ...
  return (
    <Card className="p-4 sm:p-6 lg:p-8 lg:mx-16 bg-card border-border/5 backdrop-blur-sm overflow-hidden">
      <motion.div
      ...
      >
        ...
        <div className="space-y-4">
          <h4 className="text-sm font-md text-muted-foreground">
            Last 30 days
          </h4>
                ...
                {stats.contributions.slice(-30).map((day, index) => (
                  ...
                  >
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="text-xs font-semibold text-black bg-primary">{day.count} contributions on {
